...
@Component({
  ...
  styleUrls: ['./staff.component.scss'],
    providers: [DecimalPipe, StaffserviceService]
})
...
export class StaffComponent {
    ...
    constructor(
        ...
        private _servicestaff: StaffserviceService,
    ...
    getMember() {
        this._servicestaff.getStaff().subscribe(res => {
            this.memberData = res
            console.log(this.memberData, "memberData");
        })
    }
    openModal() {
    	this._routes.navigate(['/admin/staff/add'])
    }
}
